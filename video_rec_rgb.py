...
if __name__ == "__main__":
    ...
    parser.add_argument('-o', '--out_path', type=str, help='The output video path.')
    parser.add_argument('-d', '--out_dir', type=str, default='records', help='The output video path.')
    ...
    if args.out_path is None:
        ...
        args.out_path = op.join(args.out_dir, date_time+'.avi')
