...
MMD_MOTION_FILE = r'D:\MMD\1-动作合集\3-日本歌曲\日本歌曲动作包3\magunet(Ver2)\蝶モーション.vmd'
...
def get_bone_only(path):
    motion_data = File()
    print('Loading motion file...')
    motion_data.load(filepath=path)
    ...
    return bone_state, bone_state_calculator, vam_body, motion_data
